...
@SpringBootTest
@ActiveProfiles({ProfileConstants.SPRING_PROFILE_INSECURE, ProfileConstants.SPRING_PROFILE_TEST})
public class SecurityInsecureConfigurerAdapterIntegrationTest {
